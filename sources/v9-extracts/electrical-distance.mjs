 ...
 * gridatlas/atlas/modules/202609012245-electrical-distance.js.
 *
 ...
 * network-topology.mjs's index(product).graph(). No impedance summation:
 ...
 * `window.__GRIDATLAS_MODULES__.electricalDistance`. That wiring is
 * removed; `between()` and `within()` are otherwise unchanged.
 */
