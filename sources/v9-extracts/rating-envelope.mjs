 ...
 * gridatlas/atlas/modules/202609012250-rating-envelope.js.
 *
 ...
 * `window.__GRIDATLAS_MODULES__.ratingEnvelope`. That wiring is removed;
 * `at()` and its helpers are otherwise unchanged.
 */
