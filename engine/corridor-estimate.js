 ...
 *
 * PROMOTED from sources/v9-extracts/corridor-estimate.mjs (itself
 * extracted verbatim from gridatlas/atlas/modules/202609030205-corridor-estimate.js).
 *
 ...
 * v9-geodesy.js distanceKm or geo-core.js haversine).
 *
 * CHANGED FROM THE SOURCE: the IIFE and `window.__GRIDATLAS_MODULES__`
 * registration are removed. `forCable()` is otherwise unchanged — verified
 * verbatim against gridatlas/atlas/modules/202609030205-corridor-estimate.js
 * at HEAD 64268fd06a0da54ddffbcdaaaee382e314e829f7 (see
